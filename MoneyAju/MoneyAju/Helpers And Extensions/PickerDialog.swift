...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func show(title: String, doneButtonTitle: String = "OK", cancelButtonTitle: String = "Cancelar", options: [[String: String]], selected: String? = nil, callback: @escaping PickerCallback) {
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.setTitleColor(UIColor(red:0.33, green:0.33, blue:0.33, alpha:1.0), for: UIControl.State.normal)
        self.cancelButton.setTitleColor(UIColor(red:0.33, green:0.33, blue:0.33, alpha:1.0), for: UIControl.State.highlighted)
        ...
        self.doneButton.setTitleColor(UIColor(red:0.33, green:0.33, blue:0.33, alpha:1.0), for: UIControl.State.normal)
        self.doneButton.setTitleColor(UIColor(red:0.33, green:0.33, blue:0.33, alpha:1.0), for: UIControl.State.highlighted)
